...
# payment
mpesa1 = Mpesa.create(phoneNumber: ticket3.customer.phone_number.to_s, amount: ticket1.calculate_price * ticket1.quantity, checkoutRequestID: "MR_20231026001", merchantRequestID: "ws_CO_261020231001", mpesaReceiptNumber: "LK72HN20FX", customer_id: customer1.id, ticket_id: ticket1.id)
mpesa2 = Mpesa.create(phoneNumber: ticket2.customer.phone_number.to_s, amount: ticket2.calculate_price * ticket2.quantity, checkoutRequestID: "MR_20231026003", merchantRequestID: "ws_CO_261020231003", mpesaReceiptNumber: "LK72HN20DR", customer_id: customer2.id, ticket_id: ticket2.id)
mpesa3 = Mpesa.create(phoneNumber: ticket3.customer.phone_number.to_s, amount: ticket3.calculate_price * ticket3.quantity, checkoutRequestID: "MR_20231026007", merchantRequestID: "ws_CO_261020231002", mpesaReceiptNumber: "LK72HN20FF", customer_id: customer2.id, ticket_id: ticket3.id)
